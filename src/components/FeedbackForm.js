...
function FeedbackForm(props) {
    ...
    const handleSubmit = (event) => {
        ...
        axios.post('https://support.sylvi.in/api/feedback-submit.php?firstname=' + formData.firstname + '&lastname=' + formData.lastname + '&email=' + formData.email + '&phone=' + formData.phone + '&sku=' + orderData.sku + '&design=' + design + '&valueForMoney=' + valueForMoney + '&strap=' + strap + '&buckle=' + buckle + '&durability=' + durability + '&functionality=' + functionality + '&support=' + support + '&comfort=' + comfort + '&orderId=' + orderData.orderId + '&review=' + review)
            .then((response) => {
    ...
    useEffect(() => {
        ...
        if (Object.values(formData).every((value) => value.trim() !== '')) {
            if (formData.phone.length == 10) {
                axios.post('https://support.sylvi.in/api/feedback-check.php?phone=' + formData.phone)
                    .then((response) => {
                                ...
                                <Card style={{ textAlign: "left" }}>
                                    <Row>
                                        <Col xs={(props.width > 768) ? 2 : 12}>
                                            <Image src={orderData.imageLink} thumbnail style={{ width: "171px", height: "180px" }} />
                                        </Col>
                                        <Col>
                                            <Card.Body>
